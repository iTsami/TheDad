...
# Scans That You Can Perform Using  TheDad :
+ Basic Scan
	- Site Title **NEW**
	- IP Address
...
- Version 2.0.0
	...
	- Added `MX Lookup`
	- Added `Update` option
	- TheDad Banner Updated
	- Many Other Internal Fixes

# Installation:
1. Run The Tool and Type `fix` This will Install All Required Modules.
2. For The Bloggers View To Work Properly you have to configure TheDad with moz.com's api keys for that follow the following steps:

**How To Configure TheDad with moz.com for Bloggers View Scan**
...
# Usage:
- git clone `https://github.com/iTsami/TheDad`
- cd TheDad
- php Tdad.php
...
TheDad's `CMS Detector` currently is able to detect the following CMSs (Content Management Systems) in case the website is using some other CMS, Detector will return _could not detect_.
